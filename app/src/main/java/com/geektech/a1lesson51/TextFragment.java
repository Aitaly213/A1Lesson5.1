...
public class TextFragment extends Fragment {
    ...
    public static TextFragment newInstance(String textTitle, String textSubTitle,int textImage) {
        TextFragment fragment = new TextFragment();
        Bundle args = new Bundle();
        args.putString(ARG_PARAM1, textTitle);
        args.putString(ARG_PARAM2, textSubTitle);
        args.putInt(ARG_PARAM3, textImage);
